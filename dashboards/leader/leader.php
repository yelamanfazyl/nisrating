...
<head>
  ...
  <title>
    Панель управления | Лидер шанырака
  </title>
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="leader.php">Панель управления </a>
          ...
          <div class="card shadow py-5">
            ...
            <div class="col-10 mx-auto py-5 mt-3">
                <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" id="form-main" enctype="multipart/form-data">
                    <?php 
                        $grades = R::getAll("SELECT * FROM grades, users WHERE grades.shanyrak = users.shanyrak AND users.shanyrak = :shanyrak ", array (':shanyrak'=>$_SESSION['shanyrak']));
                        if($grades != null){ 
                        ?>
