...
<?php 
  if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(isset($data['accept'])){
      $point = R::findOne("points", "id = ?", array($data['point_id']));
      if(isset($point)){
        $point->status_id = 2;
        R::store($point);
      }
            ...
            <div class="col-12 mx-auto py-5 mt-3">
              <div class="table-responsive">
                <table class="table align-items-center table-flush">
                  <tbody>
                    <?php 
                      $points = R::findAll("points", "status_id = 1");
                            ...
                            <td>
                              <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                                <div class="row mx-auto justify-content-end">
                                  ...
                                  <button class="btn btn-sm btn-success" type="submit" name="accept">Принять</button>
                                  <button class="btn btn-sm btn-danger" type="submit" name="decline">Отказать</button>
