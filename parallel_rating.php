      ...
      <div class="row">
        <div class="col-xl-12 mb-5 mb-xl-0">
          <div class="card shadow py-5 container-fluid">
            ...
            <h1 class="text-center pb-5">Рейтинг учеников среди параллели</h1>
            </div>
            ...
            <div class="col-12 mx-auto px-5 py-1 text-center">
              <div class="select_classes">
                  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="select_class">
                      <select name="select_parallel" id="select_parallel">
                  ...
                  <div class="table-responsive">
                    <table class="table align-items-center">
                      <tbody class="list">
                        ...
                        <?php
                          $students = R::find("students","grade_number = ?",array($data['select_parallel']),"ORDER BY rating DESC");
                          if(isset($students)){
